export const PlayBtn = ({ onClick }: { onClick: () => void }) => {
    return (
        <button
            onClick={onClick}
            className='relative flex items-center justify-center w-18 h-18 bg-white/40 rounded-full shadow-lg transition-transform hover:scale-110 group'
        >
